// XXX Using ctrl+f searching the addresses of the vtbls
// If I note it `Adjacent to SomeVTable`, it's probably in the front of this `SomeVTable`
...
union Union_DDD_D_SURFACE_DESC2_dw;
union Union_DDD_D_SURFACE_DESC2_D_D_COLOR_KEY;
union Union_DDD_D_SURFACE_DESC2_D_D_PIXEL_FORMAT;
union Union_D_D_PIXEL_FORMAT_dw1;
union Union_D_D_PIXEL_FORMAT_dw2;
...
enum AbstractType : __int32
{
  AbstractType_None = 0x0,
  AbstractType_Unit = 0x1,
  AbstractType_Aircraft = 0x2,
  AbstractType_AircraftType = 0x3,
  AbstractType_Anim = 0x4,
  AbstractType_AnimType = 0x5,
  AbstractType_Building = 0x6,
  AbstractType_BuildingType = 0x7,
  AbstractType_Bullet = 0x8,
  AbstractType_BulletType = 0x9,
  AbstractType_Campaign = 0xA,
  AbstractType_Cell = 0xB,
  AbstractType_Factory = 0xC,
  AbstractType_House = 0xD,
  AbstractType_HouseType = 0xE,
  AbstractType_Infantry = 0xF,
  AbstractType_InfantryType = 0x10,
  AbstractType_Isotile = 0x11,
  AbstractType_IsotileType = 0x12,
  AbstractType_BuildingLight = 0x13,
  AbstractType_Overlay = 0x14,
  AbstractType_OverlayType = 0x15,
  AbstractType_Particle = 0x16,
  AbstractType_ParticleType = 0x17,
  AbstractType_ParticleSystem = 0x18,
  AbstractType_ParticleSystemType = 0x19,
  AbstractType_Script = 0x1A,
  AbstractType_ScriptType = 0x1B,
  AbstractType_Side = 0x1C,
  AbstractType_Smudge = 0x1D,
  AbstractType_SmudgeType = 0x1E,
  AbstractType_Special = 0x1F,
  AbstractType_SuperWeaponType = 0x20,
  AbstractType_TaskForce = 0x21,
  AbstractType_Team = 0x22,
  AbstractType_TeamType = 0x23,
  AbstractType_Terrain = 0x24,
  AbstractType_TerrainType = 0x25,
  AbstractType_Trigger = 0x26,
  AbstractType_TriggerType = 0x27,
  AbstractType_UnitType = 0x28,
  AbstractType_VoxelAnim = 0x29,
  AbstractType_VoxelAnimType = 0x2A,
  AbstractType_Wave = 0x2B,
  AbstractType_Tag = 0x2C,
  AbstractType_TagType = 0x2D,
  AbstractType_Tiberium = 0x2E,
  AbstractType_Action = 0x2F,
  AbstractType_Event = 0x30,
  AbstractType_WeaponType = 0x31,
  AbstractType_WarheadType = 0x32,
  AbstractType_Waypoint = 0x33,
  AbstractType_Abstract = 0x34,
  AbstractType_Tube = 0x35,
  AbstractType_LightSource = 0x36,
  AbstractType_EMPulse = 0x37,
  AbstractType_TacticalMap = 0x38,
  AbstractType_Super = 0x39,
  AbstractType_AITrigger = 0x3A,
  AbstractType_AITriggerType = 0x3B,
  AbstractType_Neuron = 0x3C,
  AbstractType_FoggedObject = 0x3D,
  AbstractType_AlphaShape = 0x3E,
  AbstractType_VeinholeMonster = 0x3F,
  AbstractType_NavyType = 0x40,
  AbstractType_SpawnManager = 0x41,
  AbstractType_CaptureManager = 0x42,
  AbstractType_Parasite = 0x43,
  AbstractType_Bomb = 0x44,
  AbstractType_RadSite = 0x45,
  AbstractType_Temporal = 0x46,
  AbstractType_Airstrike = 0x47,
  AbstractType_SlaveManager = 0x48,
...
{
  TheaterType_None = -1,
  TheaterType_Temperate = 0,
  TheaterType_Snow = 1,
  TheaterType_Urban = 2,
  TheaterType_Desert = 3,
  TheaterType_NewUrban = 4,
  TheaterType_Lunar = 5,
};
...
enum TriggerPersistence : __int32
{
  TriggerPersistence_Volatile = 0x0,
  TriggerPersistence_SemiPersistant = 0x1,
  TriggerPersistence_Persistent = 0x2,
};

enum AIDifficulty : unsigned int
{
  AIDifficulty_Hard = 0,
  AIDifficulty_Normal = 1,
  AIDifficulty_Easy = 2
};
...
{
  AIMode_General = 0x0,
  AIMode_LowOnCash = 0x1,
  AIMode_BuildBase = 0x3,
  AIMode_SellAll = 0x4,
};
...
{
  TargetType_None = 0,
  TargetType_Anything = 1,
  TargetType_Buildings = 2,
  TargetType_Harvesters = 3,
...
{
  SoundPriority_Lowest = 0,
  SoundPriority_Low = 1,
  SoundPriority_Normal = 2,
  SoundPriority_High = 3,
...
enum SoundType : unsigned int
{
  ...
  SoundType_Quiet = 0x4,
  SoundType_Loud = 0x8,
  SoundType_Global = 0x10,
  SoundType_Screen = 0x20,
  SoundType_Local = 0x40,
  SoundType_Player = 0x80,
  SoundType_NoiseShy = 0x100,
  SoundType_GunShy = 0x200,
  SoundType_Unshroud = 0x400,
  SoundType_Shroud = 0x800,
...
enum FileAccessMode : unsigned int
{
  FileAccessMode_None = 0,
  FileAccessMode_Read = 1,
  FileAccessMode_Write = 2,
  FileAccessMode_ReadWrite = FileAccessMode_Read | FileAccessMode_Write
};

enum FileSeekMode : unsigned int
{
  FileSeekMode_Set = 0,
  FileSeekMode_Current = 1,
  FileSeekMode_End = 2
};

enum VisualType : __int32
{
  VisualType_Normal = 0x0,
  VisualType_Indistinct = 0x1,
  VisualType_Darken = 0x2,
  VisualType_Shadowy = 0x3,
  VisualType_Ripple = 0x4,
  VisualType_Hidden = 0x5,
};
...
enum Action : unsigned int
{
  ...
  Action_NoMove = 2,
  Action_Enter = 3,
  Action_Self_Deploy = 4,
  Action_Attack = 5,
  Action_Harvest = 6,
  Action_Select = 7,
  Action_ToggleSelect = 8,
  Action_Capture = 9,
  Action_Eaten = 10,
  Action_Repair = 11,
  Action_Sell = 12,
  ...
  Action_NoEnter = 31,
  Action_NoGRepair = 32,
  Action_TogglePower = 33,
  Action_NoTogglePower = 34,
  Action_EnterTunnel = 35,
  Action_NoEnterTunnel = 36,
  Action_IronCurtain = 37,
  Action_LightningStorm = 38,
  Action_ChronoSphere = 39,
  Action_ChronoWarp = 40,
  Action_ParaDrop = 41,
  Action_PlaceWaypoint = 42,
  Action_TibSunBug = 43,
  Action_EnterWaypointMode = 44,
  Action_FollowWaypoint = 45,
  Action_SelectWaypoint = 46,
  Action_LoopWaypointPath = 47,
  Action_DragWaypoint = 48,
  Action_AttackWaypoint = 49,
  Action_EnterWaypoint = 50,
  Action_PatrolWaypoint = 51,
  Action_AreaAttack = 52,
  Action_IvanBomb = 53,
  Action_NoIvanBomb = 54,
  Action_Detonate = 55,
  Action_DetonateAll = 56,
  Action_DisarmBomb = 57,
  Action_SelectNode = 58,
  Action_AttackSupport = 59,
  Action_PlaceBeacon = 60,
  Action_SelectBeacon = 61,
  Action_AttackMoveNav = 62,
  Action_AttackMoveTar = 63,
  Action_Demolish = 64,
  Action_AmerParaDrop = 65,
  Action_PsychicDominator = 66,
  Action_SpyPlane = 67,
  Action_GeneticConverter = 68,
  Action_ForceShield = 69,
  Action_NoForceShield = 70,
  Action_Airstrike = 71,
  Action_PsychicReveal = 72
};

enum DirType : __int8
{
  DirType_North = 0x0,
  DirType_NorthEast = 0x20,
  DirType_East = 0x40,
  DirType_SouthEast = 0x60,
  DirType_South = 0x80,
  DirType_SouthWest = 0xA0,
  DirType_West = 0xC0,
  DirType_NorthWest = 0xE0,
  DirType_Max = 0xFF,
};

enum KickOutResult : __int32
{
  KickOutResult_Failed = 0x0,
  KickOutResult_Busy = 0x1,
  KickOutResult_Succeeded = 0x2,
};

enum MarkType : __int32
{
  MarkType_Up = 0x0,
  MarkType_Down = 0x1,
  MarkType_Change = 0x2,
  MarkType_ChangeRedraw = 0x3,
  MarkType_OverlapDown = 0x4,
  MarkType_OverlapUp = 0x5,
};

enum DamageState : __int32
{
  DamageState_Unaffected = 0x0,
  DamageState_Unchanged = 0x1,
  DamageState_NowYellow = 0x2,
  DamageState_NowRed = 0x3,
  DamageState_NowDead = 0x4,
  DamageState_PostMortem = 0x5,
};
...
enum PCPType : __int8
{
  PCPType_Rotation = 0x0,
  PCPType_During = 0x1,
  PCPType_End = 0x2,
};

enum RadioCommand : __int32
{
  RadioCommand_AnswerInvalid = 0x0,
  RadioCommand_AnswerPositive = 0x1,
  RadioCommand_RequestLink = 0x2,
  RadioCommand_NotifyUnlink = 0x3,
  RadioCommand_unknown_4 = 0x4,
  RadioCommand_unknown_5 = 0x5,
  RadioCommand_unknown_6 = 0x6,
  RadioCommand_NotifyBeginLoad = 0x7,
  RadioCommand_NotifyUnloaded = 0x8,
  RadioCommand_RequestUnload = 0x9,
  RadioCommand_AnswerNegative = 0xA,
  RadioCommand_RequestBeginProduction = 0xB,
  RadioCommand_RequestEndProduction = 0xC,
  RadioCommand_RequestRedraw = 0xD,
  RadioCommand_RequestLoading = 0xE,
  RadioCommand_AnswerLoading = 0xE,
  RadioCommand_QueryCanEnter = 0xF,
  RadioCommand_QueryCanUnload = 0x10,
  RadioCommand_QueryWantEnter = 0x11,
  RadioCommand_RequestMoveTo = 0x12,
  RadioCommand_QueryMoving = 0x13,
  RadioCommand_AnswerAwaiting = 0x14,
  RadioCommand_RequestCompleteEnter = 0x15,
  RadioCommand_RequestDockRefinery = 0x16,
  RadioCommand_AnswerLeave = 0x17,
  RadioCommand_NotifyLeave = 0x17,
  RadioCommand_RequestTether = 0x18,
  RadioCommand_RequestUntether = 0x19,
  RadioCommand_RequestAlternativeTether = 0x1A,
  RadioCommand_RequestAlternativeUntether = 0x1B,
  RadioCommand_RequestRepair = 0x1C,
  RadioCommand_QueryReadiness = 0x1D,
  RadioCommand_RequestAttack = 0x1E,
  RadioCommand_RequestReload = 0x1F,
  RadioCommand_AnswerBlocked = 0x20,
  RadioCommand_QueryDone = 0x21,
  RadioCommand_AnswerDone = 0x21,
  RadioCommand_QueryNeedRepair = 0x22,
  RadioCommand_QueryOnBuilding = 0x23,
  RadioCommand_QueryCanTote = 0x24,
};

enum FacingType : char
{
  FacingType_North = 0,
  FacingType_NorthEast = 1,
  FacingType_East = 2,
  FacingType_SouthEast = 3,
  FacingType_South = 4,
  FacingType_SouthWest = 5,
  FacingType_West = 6,
  FacingType_NorthWest = 7,
  FacingType_Count = 8,
  FacingType_None = -1,
};
...
enum Move : __int32
{
  Move_OK = 0x0,
  Move_Cloak = 0x1,
  Move_MovingBlock = 0x2,
  Move_ClosedGate = 0x3,
  Move_FriendlyDestroyable = 0x4,
  Move_Destroyable = 0x5,
  Move_Temp = 0x6,
  Move_No = 0x7,
};

enum Armor : unsigned int
{
  Armor_None = 0,
  Armor_Flak = 1,
  Armor_Plate = 2,
...
enum BlitterFlags : unsigned int
{
  ...
  BlitterFlags_bf_040 = 0x40,
  BlitterFlags_bf_080 = 0x80,
  BlitterFlags_MultiPass = 0x100,
  BlitterFlags_Centered = 0x200,
  BlitterFlags_bf_400 = 0x400,
  ...
  BlitterFlags_Nonzero = 0x20000
};

enum SuperWeaponType : int
{
  SuperWeaponType_Invalid = -1,
  SuperWeaponType_Nuke = 0,
  SuperWeaponType_IronCurtain = 1,
  SuperWeaponType_LightningStorm = 2,
  SuperWeaponType_ChronoSphere = 3,
  SuperWeaponType_ChronoWarp = 4,
  SuperWeaponType_ParaDrop = 5,
  SuperWeaponType_AmerParaDrop = 6,
  SuperWeaponType_PsychicDominator = 7,
  SuperWeaponType_SpyPlane = 8,
  SuperWeaponType_GeneticMutator = 9,
  SuperWeaponType_ForceShield = 10,
  SuperWeaponType_PsychicReveal = 11
};

enum TriggerEvent : unsigned int
{
  TriggerEvent_None = 0x0,
  TriggerEvent_EnteredBy = 0x1,
  TriggerEvent_SpiedBy = 0x2,
  TriggerEvent_ThievedBy = 0x3,
  TriggerEvent_DiscoveredByPlayer = 0x4,
  TriggerEvent_HouseDiscovered = 0x5,
  TriggerEvent_AttackedByAnybody = 0x6,
  TriggerEvent_DestroyedByAnybody = 0x7,
  TriggerEvent_AnyEvent = 0x8,
  TriggerEvent_DestroyedUnitsAll = 0x9,
  TriggerEvent_DestroyedBuildingsAll = 0xA,
  TriggerEvent_DestroyedAll = 0xB,
  TriggerEvent_CreditsExceed = 0xC,
  TriggerEvent_ElapsedTime = 0xD,
  TriggerEvent_MissionTimerExpired = 0xE,
  TriggerEvent_DestroyedBuildingsNum = 0xF,
  TriggerEvent_DestroyedUnitsNum = 0x10,
  TriggerEvent_NoFactoriesLeft = 0x11,
  TriggerEvent_CiviliansEvacuated = 0x12,
  TriggerEvent_BuildBuildingType = 0x13,
  TriggerEvent_BuildUnitType = 0x14,
  TriggerEvent_BuildInfantryType = 0x15,
  TriggerEvent_BuildAircraftType = 0x16,
  TriggerEvent_TeamLeavesMap = 0x17,
  TriggerEvent_ZoneEntryBy = 0x18,
  TriggerEvent_CrossesHorizontalLine = 0x19,
  TriggerEvent_CrossesVerticalLine = 0x1A,
  TriggerEvent_GlobalSet = 0x1B,
  TriggerEvent_GlobalCleared = 0x1C,
  TriggerEvent_DestroyedFakesAll = 0x1D,
  TriggerEvent_LowPower = 0x1E,
  TriggerEvent_AllBridgesDestroyed = 0x1F,
  TriggerEvent_BuildingExists = 0x20,
  TriggerEvent_SelectedByPlayer = 0x21,
  TriggerEvent_ComesNearWaypoint = 0x22,
  TriggerEvent_EnemyInSpotlight = 0x23,
  TriggerEvent_LocalSet = 0x24,
  TriggerEvent_LocalCleared = 0x25,
  TriggerEvent_FirstDamaged_combatonly = 0x26,
  TriggerEvent_HalfHealth_combatonly = 0x27,
  TriggerEvent_QuarterHealth_combatonly = 0x28,
  TriggerEvent_FirstDamaged_anysource = 0x29,
  TriggerEvent_HalfHealth_anysource = 0x2A,
  TriggerEvent_QuarterHealth_anysource = 0x2B,
  TriggerEvent_AttackedByHouse = 0x2C,
  TriggerEvent_AmbientLightBelow = 0x2D,
  TriggerEvent_AmbientLightAbove = 0x2E,
  TriggerEvent_ElapsedScenarioTime = 0x2F,
  TriggerEvent_DestroyedByAnything = 0x30,
  TriggerEvent_PickupCrate = 0x31,
  TriggerEvent_PickupCrate_any = 0x32,
  TriggerEvent_RandomDelay = 0x33,
  TriggerEvent_CreditsBelow = 0x34,
  TriggerEvent_SpyAsHouse = 0x35,
  TriggerEvent_SpyAsInfantry = 0x36,
  TriggerEvent_DestroyedUnitsNaval = 0x37,
  TriggerEvent_DestroyedUnitsLand = 0x38,
  TriggerEvent_BuildingDoesNotExist = 0x39,
  TriggerEvent_PowerFull = 0x3A,
  TriggerEvent_EnteredOrOverflownBy = 0x3B,
  TriggerEvent_TechTypeExists = 0x3C,
  TriggerEvent_TechTypeDoesntExist = 0x3D
};

enum TriggerAction : unsigned int
{
  TriggerAction_None = 0x0,
  TriggerAction_Win = 0x1,
  TriggerAction_Lose = 0x2,
  TriggerAction_ProductionBegins = 0x3,
  TriggerAction_CreateTeam = 0x4,
  TriggerAction_DestroyTeam = 0x5,
  TriggerAction_AllToHunt = 0x6,
  TriggerAction_Reinforcement = 0x7,
  TriggerAction_DropZoneFlare = 0x8,
  TriggerAction_FireSale = 0x9,
  TriggerAction_PlayMovie = 0xA,
  TriggerAction_TextTrigger = 0xB,
  TriggerAction_DestroyTrigger = 0xC,
  TriggerAction_AutocreateBegins = 0xD,
  TriggerAction_ChangeHouse = 0xE,
  TriggerAction_AllowWin = 0xF,
  TriggerAction_RevealAllMap = 0x10,
  TriggerAction_RevealAroundWaypoint = 0x11,
  TriggerAction_RevealWaypointZone = 0x12,
  TriggerAction_PlaySoundEffect = 0x13,
  TriggerAction_PlayMusicTheme = 0x14,
  TriggerAction_PlaySpeech = 0x15,
  TriggerAction_ForceTrigger = 0x16,
  TriggerAction_TimerStart = 0x17,
  TriggerAction_TimerStop = 0x18,
  TriggerAction_TimerExtend = 0x19,
  TriggerAction_TimerShorten = 0x1A,
  TriggerAction_TimerSet = 0x1B,
  TriggerAction_GlobalSet = 0x1C,
  TriggerAction_GlobalClear = 0x1D,
  TriggerAction_AutoBaseBuilding = 0x1E,
  TriggerAction_GrowShroud = 0x1F,
  TriggerAction_DestroyAttachedObject = 0x20,
  TriggerAction_AddOneTimeSuperWeapon = 0x21,
  TriggerAction_AddRepeatingSuperWeapon = 0x22,
  TriggerAction_PreferredTarget = 0x23,
  TriggerAction_AllChangeHouse = 0x24,
  TriggerAction_MakeAlly = 0x25,
  TriggerAction_MakeEnemy = 0x26,
  TriggerAction_ChangeZoomLevel = 0x27,
  TriggerAction_ResizePlayerView = 0x28,
  TriggerAction_PlayAnimAt = 0x29,
  TriggerAction_DoExplosionAt = 0x2A,
  TriggerAction_CreateVoxelAnim = 0x2B,
  TriggerAction_IonStormStart = 0x2C,
  TriggerAction_IonStormStop = 0x2D,
  TriggerAction_LockInput = 0x2E,
  TriggerAction_UnlockInput = 0x2F,
  TriggerAction_MoveCameraToWaypoint = 0x30,
  TriggerAction_ZoomIn = 0x31,
  TriggerAction_ZoomOut = 0x32,
  TriggerAction_ReshroudMap = 0x33,
  TriggerAction_ChangeLightBehavior = 0x34,
  TriggerAction_EnableTrigger = 0x35,
  TriggerAction_DisableTrigger = 0x36,
  TriggerAction_CreateRadarEvent = 0x37,
  TriggerAction_LocalSet = 0x38,
  TriggerAction_LocalClear = 0x39,
  TriggerAction_MeteorShower = 0x3A,
  TriggerAction_ReduceTiberium = 0x3B,
  TriggerAction_SellBuilding = 0x3C,
  TriggerAction_TurnOffBuilding = 0x3D,
  TriggerAction_TurnOnBuilding = 0x3E,
  TriggerAction_Apply100Damage = 0x3F,
  TriggerAction_SmallLightFlash = 0x40,
  TriggerAction_MediumLightFlash = 0x41,
  TriggerAction_LargeLightFlash = 0x42,
  TriggerAction_AnnounceWin = 0x43,
  TriggerAction_AnnounceLose = 0x44,
  TriggerAction_ForceEnd = 0x45,
  TriggerAction_DestroyTag = 0x46,
  TriggerAction_SetAmbientStep = 0x47,
  TriggerAction_SetAmbientRate = 0x48,
  TriggerAction_SetAmbientLight = 0x49,
  TriggerAction_AITriggersBegin = 0x4A,
  TriggerAction_AITriggersStop = 0x4B,
  TriggerAction_RatioOfAITriggerTeams = 0x4C,
  TriggerAction_RatioOfTeamAircraft = 0x4D,
  TriggerAction_RatioOfTeamInfantry = 0x4E,
  TriggerAction_RatioOfTeamUnits = 0x4F,
  TriggerAction_ReinforcementAt = 0x50,
  TriggerAction_WakeupSelf = 0x51,
  TriggerAction_WakeupAllSleepers = 0x52,
  TriggerAction_WakeupAllHarmless = 0x53,
  TriggerAction_WakeupGroup = 0x54,
  TriggerAction_VeinGrowth = 0x55,
  TriggerAction_TiberiumGrowth = 0x56,
  TriggerAction_IceGrowth = 0x57,
  TriggerAction_ParticleAnim = 0x58,
  TriggerAction_RemoveParticleAnim = 0x59,
  TriggerAction_LightningStrike = 0x5A,
  TriggerAction_GoBerzerk = 0x5B,
  TriggerAction_ActivateFirestorm = 0x5C,
  TriggerAction_DeactivateFirestorm = 0x5D,
  TriggerAction_IonCannonStrike = 0x5E,
  TriggerAction_NukeStrike = 0x5F,
  TriggerAction_ChemMissileStrike = 0x60,
  TriggerAction_ToggleTrainCargo = 0x61,
  TriggerAction_PlaySoundEffectRandom = 0x62,
  TriggerAction_PlaySoundEffectAtWaypoint = 0x63,
  TriggerAction_PlayIngameMovie = 0x64,
  TriggerAction_ReshroudMapAtWaypoint = 0x65,
  TriggerAction_LightningStormStrike = 0x66,
  TriggerAction_TimerText = 0x67,
  TriggerAction_FlashTeam = 0x68,
  TriggerAction_TalkBubble = 0x69,
  TriggerAction_SetObjectTechLevel = 0x6A,
  TriggerAction_ReinforcementByChrono = 0x6B,
  TriggerAction_CreateCrate = 0x6C,
  TriggerAction_IronCurtain = 0x6D,
  TriggerAction_PauseGame = 0x6E,
  TriggerAction_EvictOccupiers = 0x6F,
  TriggerAction_CenterCameraAtWaypoint = 0x70,
  TriggerAction_MakeHouseCheer = 0x71,
  TriggerAction_SetTabTo = 0x72,
  TriggerAction_FlashCameo = 0x73,
  TriggerAction_StopSounds = 0x74,
  TriggerAction_PlayIngameMovieAndPause = 0x75,
  TriggerAction_ClearAllSmudges = 0x76,
  TriggerAction_DestroyAll = 0x77,
  TriggerAction_DestroyAllBuildings = 0x78,
  TriggerAction_DestroyAllLandUnits = 0x79,
  TriggerAction_DestroyAllNavalUnits = 0x7A,
  TriggerAction_MindControlBase = 0x7B,
  TriggerAction_RestoreMindControlledBase = 0x7C,
  TriggerAction_CreateBuilding = 0x7D,
  TriggerAction_RestoreStartingUnits = 0x7E,
  TriggerAction_StartChronoScreenEffect = 0x7F,
  TriggerAction_TeleportAll = 0x80,
  TriggerAction_SetSuperWeaponCharge = 0x81,
  TriggerAction_RestoreStartingBuildings = 0x82,
  TriggerAction_FlashBuildingsOfType = 0x83,
  TriggerAction_SuperWeaponSetRechargeTime = 0x84,
  TriggerAction_SuperWeaponResetRechargeTime = 0x85,
  TriggerAction_SuperWeaponReset = 0x86,
  TriggerAction_SetPreferredTargetCell = 0x87,
  TriggerAction_ClearPreferredTargetCell = 0x88,
  TriggerAction_SetBaseCenterCell = 0x89,
  TriggerAction_ClearBaseCenterCell = 0x8A,
  TriggerAction_BlackoutRadar = 0x8B,
  TriggerAction_SetDefensiveTargetCell = 0x8C,
  TriggerAction_ClearDefensiveTargetCell = 0x8D,
  TriggerAction_RetintRed = 0x8E,
  TriggerAction_RetintGreen = 0x8F,
  TriggerAction_RetintBlue = 0x90,
  TriggerAction_JumpCameraHome = 0x91
};

enum ParasiteState : __int32
{
  ParasiteState_Start = 0x0,
  ParasiteState_Grab = 0x1,
  ParasiteState_PushLeft = 0x2,
  ParasiteState_PushRight = 0x3,
  ParasiteState_Damage = 0x4,
};

enum SpawnManagerStatus : unsigned int
{
  SpawnManagerStatus_Idle = 0,
  SpawnManagerStatus_Launching = 1,
  SpawnManagerStatus_CoolDown = 2
};

enum SpawnNodeStatus : unsigned int
{
  SpawnNodeStatus_Idle = 0,
  SpawnNodeStatus_TakeOff = 1,
  SpawnNodeStatus_Preparing = 2,
  SpawnNodeStatus_Attacking = 3,
  SpawnNodeStatus_Returning = 4,
  SpawnNodeStatus_Reloading = 6,
  SpawnNodeStatus_Dead = 7
};

enum SlaveManagerStatus : unsigned int
{
  SlaveManagerStatus_Ready = 0,
  SlaveManagerStatus_Scanning = 1,
  SlaveManagerStatus_Travelling = 2,
  SlaveManagerStatus_Deploying = 3,
  SlaveManagerStatus_Working = 4,
  SlaveManagerStatus_ScanningAgain = 5,
  SlaveManagerStatus_PackingUp = 6
};

enum SlaveControlStatus : unsigned int
{
  SlaveControlStatus_Unknown = 0,
  SlaveControlStatus_ScanningForTiberium = 1,
  SlaveControlStatus_MovingToTiberium = 2,
  SlaveControlStatus_Harvesting = 3,
  SlaveControlStatus_BringingItBack = 4,
  SlaveControlStatus_Respawning = 5,
  SlaveControlStatus_Dead = 6
};

enum AITriggerCondition : __int32
{
  AITriggerCondition_Pool = 0xFFFFFFFF,
  AITriggerCondition_AIOwns = 0x0,
  AITriggerCondition_EnemyOwns = 0x1,
  AITriggerCondition_EnemyYellowPowe = 0x2,
  AITriggerCondition_EnemyRedPower = 0x3,
  AITriggerCondition_EnemyCashExceeds = 0x4,
  AITriggerCondition_IronCharged = 0x5,
  AITriggerCondition_ChronoCharged = 0x6,
  AITriggerCondition_NeutralOwns = 0x7,
};

enum AITriggerHouseType : int
{
  AITriggerHouseType_None = 0,
  AITriggerHouseType_Single = 1,
  AITriggerHouseType_Any = 2
};

enum InfDeath : unsigned int
{
  InfDeath_None = 0,
  InfDeath_Die1 = 1,
  InfDeath_Die2 = 2,
...
enum BehavesLike : __int32
{
  BehavesLike_Smoke = 0x0,
  BehavesLike_Gas = 0x1,
  BehavesLike_Fire = 0x2,
  BehavesLike_Spark = 0x3,
  BehavesLike_Railgun = 0x4,
};
...
enum PassabilityType : unsigned int
{
  PassabilityType_Passable = 0,
  PassabilityType_Crushable = 1,
  PassabilityType_Destroyable = 2,
...
enum CellFlags : unsigned int
{
  ...
  CellFlags_Explored = 0x8,
  CellFlags_FlagPresent = 0x10,
  CellFlags_FlagToShroud = 0x20,
  CellFlags_IsPlot = 0x40,
  CellFlags_BridgeOwner = 0x80,
  CellFlags_BridgeHead = 0x100,
  CellFlags_Unknown_200 = 0x200,
  CellFlags_BridgeBody = 0x400,
  CellFlags_BridgeDir = 0x800,
  CellFlags_PixelFX = 0x1000,
  CellFlags_Unknown_2000 = 0x2000,
  CellFlags_Unknown_4000 = 0x4000,
  CellFlags_Veinhole = 0x8000,
  CellFlags_DrawDarkenIfInAir = 0x10000,
  CellFlags_AnimAttached = 0x20000,
  CellFlags_Tube = 0x40000,
  CellFlags_EMPPresent = 0x80000,
...
enum CloakState : __int32
{
  CloakState_Uncloaked = 0x0,
  CloakState_Cloaking = 0x1,
  CloakState_Cloaked = 0x2,
  CloakState_Uncloaking = 0x3,
};

enum RecoilData_RecoilState : __int32
{
  RecoilData_RecoilState_Inactive = 0x0,
  RecoilData_RecoilState_Compressing = 0x1,
  RecoilData_RecoilState_Holding = 0x2,
  RecoilData_RecoilState_Recovering = 0x3,
};

enum WaveType : __int32
{
  WaveType_Sonic = 0x0,
  WaveType_BigLaser = 0x1,
  WaveType_Laser = 0x2,
  WaveType_Magnetron = 0x3,
};
...
enum FireError : int
{
  ...
  FireError_CLOAKED = 9,
  FireError_BUSY = 10,
  FireError_MUST_DEPLOY = 11
};

enum PipScale : unsigned int
{
  PipScale_None = 0,
  PipScale_Ammo = 1,
  PipScale_Tiberium = 2,
  PipScale_Passengers = 3,
  PipScale_Power = 4,
  PipScale_MindControl = 5
};

enum MovementZone : int
{
  MovementZone_None = -1,
  MovementZone_Normal = 0,
  MovementZone_Crusher = 1,
  MovementZone_Destroyer = 2,
  MovementZone_AmphibiousDestroyer = 3,
  MovementZone_AmphibiousCrusher = 4,
  MovementZone_Amphibious = 5,
  MovementZone_Subterrannean = 6,
  MovementZone_Infantry = 7,
  MovementZone_InfantryDestroyer = 8,
  MovementZone_Fly = 9,
  MovementZone_Water = 10,
  MovementZone_WaterBeach = 11,
  MovementZone_CrusherAll = 12
};

enum NavalTargetingType : __int32
{
  NavalTargetingType_Underwater_Never = 0x0,
  NavalTargetingType_Underwater_Secondary = 0x1,
  NavalTargetingType_Underwater_Only = 0x2,
  NavalTargetingType_Organic_Secondary = 0x3,
  NavalTargetingType_SEAL_Special = 0x4,
  NavalTargetingType_Naval_All = 0x5,
  NavalTargetingType_Naval_None = 0x6,
  NavalTargetingType_Naval_Primary = 0x7,
};

enum LandTargetingType : __int32
{
  LandTargetingType_Land_OK = 0x0,
  LandTargetingType_Land_Not_OK = 0x1,
  LandTargetingType_Land_Secondary = 0x2,
};
...
enum SpeedType : int
{
  ...
  SpeedType_Winged = 4,
  SpeedType_Float = 5,
  SpeedType_Amphibious = 6,
  SpeedType_FloatBeach = 7
};

enum MouseCursorType : unsigned int
{
  MouseCursorType_Default = 0x0,
  MouseCursorType_Move_N = 0x1,
  MouseCursorType_Move_NE = 0x2,
  MouseCursorType_Move_E = 0x3,
  MouseCursorType_Move_SE = 0x4,
  MouseCursorType_Move_S = 0x5,
  MouseCursorType_Move_SW = 0x6,
  MouseCursorType_Move_W = 0x7,
  MouseCursorType_Move_NW = 0x8,
  MouseCursorType_NoMove_N = 0x9,
  MouseCursorType_NoMove_NE = 0xA,
  MouseCursorType_NoMove_E = 0xB,
  MouseCursorType_NoMove_SE = 0xC,
  MouseCursorType_NoMove_S = 0xD,
  MouseCursorType_NoMove_SW = 0xE,
  MouseCursorType_NoMove_W = 0xF,
  MouseCursorType_NoMove_NW = 0x10,
  MouseCursorType_Select = 0x11,
  MouseCursorType_Move = 0x12,
  MouseCursorType_NoMove = 0x13,
  MouseCursorType_Attack = 0x14,
  MouseCursorType_AttackOutOfRange = 0x15,
  MouseCursorType_Protect = 0x16,
  MouseCursorType_DesolatorDeploy = 0x17,
  MouseCursorType_Cursor_18 = 0x18,
  MouseCursorType_Enter = 0x19,
  MouseCursorType_NoEnter = 0x1A,
  MouseCursorType_Deploy = 0x1B,
  MouseCursorType_NoDeploy = 0x1C,
  MouseCursorType_Cursor_1D = 0x1D,
  MouseCursorType_Sell = 0x1E,
  MouseCursorType_SellUnit = 0x1F,
  MouseCursorType_NoSell = 0x20,
  MouseCursorType_Repair = 0x21,
  MouseCursorType_EngineerRepair = 0x22,
  MouseCursorType_NoRepair = 0x23,
  MouseCursorType_Waypoint = 0x24,
  MouseCursorType_Disguise = 0x25,
  MouseCursorType_IvanBomb = 0x26,
  MouseCursorType_MindControl = 0x27,
  MouseCursorType_RemoveSquid = 0x28,
  MouseCursorType_Crush = 0x29,
  MouseCursorType_SpyTech = 0x2A,
  MouseCursorType_SpyPower = 0x2B,
  MouseCursorType_Cursor_2C = 0x2C,
  MouseCursorType_GIDeploy = 0x2D,
  MouseCursorType_Cursor_2E = 0x2E,
  MouseCursorType_ParaDrop = 0x2F,
  MouseCursorType_Cursor_30 = 0x30,
  MouseCursorType_CloseWaypoint = 0x31,
  MouseCursorType_LightningStorm = 0x32,
  MouseCursorType_Detonate = 0x33,
  MouseCursorType_Demolish = 0x34,
  MouseCursorType_Nuke = 0x35,
  MouseCursorType_Cursor_36 = 0x36,
  MouseCursorType_Power = 0x37,
  MouseCursorType_Cursor_38 = 0x38,
  MouseCursorType_IronCurtain = 0x39,
  MouseCursorType_Chronosphere = 0x3A,
  MouseCursorType_Disarm = 0x3B,
  MouseCursorType_Disallowed = 0x3C,
  MouseCursorType_Scroll = 0x3D,
  MouseCursorType_Scroll_ESW = 0x3E,
  MouseCursorType_Scroll_SW = 0x3F,
  MouseCursorType_Scroll_NSW = 0x40,
  MouseCursorType_Scroll_NW = 0x41,
  MouseCursorType_Scroll_NEW = 0x42,
  MouseCursorType_Scroll_NE = 0x43,
  MouseCursorType_Scroll_NES = 0x44,
  MouseCursorType_Scroll_ES = 0x45,
  MouseCursorType_Protect2 = 0x46,
  MouseCursorType_AttackOutOfRange2 = 0x47,
  MouseCursorType_Cursor_48 = 0x48,
  MouseCursorType_InfantryAbsorb = 0x49,
  MouseCursorType_NoMindControl = 0x4A,
  MouseCursorType_Cursor_4B = 0x4B,
  MouseCursorType_Cursor_4C = 0x4C,
  MouseCursorType_Cursor_4D = 0x4D,
  MouseCursorType_Beacon = 0x4E,
  MouseCursorType_ForceShield = 0x4F,
  MouseCursorType_NoForceShield = 0x50,
  MouseCursorType_GeneticMutator = 0x51,
  MouseCursorType_AirStrike = 0x52,
  MouseCursorType_PsychicDominator = 0x53,
  MouseCursorType_PsychicReveal = 0x54,
...
enum GadgetFlag : __int32
{
  ...
  GadgetFlag_LeftUp = 0x8,
  GadgetFlag_RightPress = 0x10,
  GadgetFlag_RightHeld = 0x20,
  GadgetFlag_RightRelease = 0x40,
  GadgetFlag_RightUp = 0x80,
  GadgetFlag_Keyboard = 0x100,
};
...
{
  SpotlightBehaviour_None = 0,
  SpotlightBehaviour_Sweep = 1,
  SpotlightBehaviour_Circle = 2,
  SpotlightBehaviour_Follow = 3
};

enum PrismChargeState : __int32
{
  PrismChargeState_Idle = 0x0,
  PrismChargeState_Master = 0x1,
  PrismChargeState_Slave = 0x2,
};
...
enum EventType : unsigned char
{
  ...
  EventType_MegaMissionF = 0x5,
  EventType_Idle = 0x6,
  EventType_Scatter = 0x7,
  EventType_Destruct = 0x8,
  EventType_Deploy = 0x9,
  EventType_Detonate = 0xA,
  EventType_Place = 0xB,
  EventType_Options = 0xC,
  EventType_GameSpeed = 0xD,
  EventType_Produce = 0xE,
  EventType_Suspend = 0xF,
  EventType_Abandon = 0x10,
  EventType_Primary = 0x11,
  EventType_SpecialPlace = 0x12,
  EventType_Exit = 0x13,
  EventType_Animation = 0x14,
  EventType_Repair = 0x15,
  EventType_Sell = 0x16,
  EventType_SellCell = 0x17,
  EventType_Special = 0x18,
  EventType_FrameSync = 0x19,
  EventType_Message = 0x1A,
  EventType_ResponseTime = 0x1B,
  EventType_FrameInfo = 0x1C,
  EventType_SaveGame = 0x1D,
  EventType_Archive = 0x1E,
  EventType_AddPlayer = 0x1F,
  EventType_Timing = 0x20,
  EventType_ProcessTime = 0x21,
  EventType_PageUser = 0x22,
  EventType_RemovePlayer = 0x23,
  EventType_LatencyFudge = 0x24,
  EventType_MegaFrameInfo = 0x25,
  EventType_PacketTiming = 0x26,
  EventType_AboutToExit = 0x27,
  EventType_FallbackHost = 0x28,
  EventType_AddressChange = 0x29,
  EventType_PlanConnect = 0x2A,
  EventType_PlanCommit = 0x2B,
  EventType_PlanNodeDelete = 0x2C,
  EventType_AllCheer = 0x2D,
  EventType_AbandonAll = 0x2E,
...
{
  BuildCat_DontCare = 0x0,
  BuildCat_Tech = 0x1,
  BuildCat_Resoure = 0x2,
  BuildCat_Power = 0x3,
  BuildCat_Infrastructure = 0x4,
  BuildCat_Combat = 0x5,
};

enum Foundation : __int32
{
  Foundation_1x1 = 0x0,
  Foundation_2x1 = 0x1,
  Foundation_1x2 = 0x2,
...
enum Sequence : int
{
  ...
  Sequence_Tread = 16,
  Sequence_Swim = 17,
  Sequence_WetIdle1 = 18,
  Sequence_WetIdle2 = 19,
  Sequence_WetDie1 = 20,
  Sequence_WetDie2 = 21,
  Sequence_WetAttack = 22,
  Sequence_Hover = 23,
  Sequence_Fly = 24,
  Sequence_Tumble = 25,
  Sequence_FireFly = 26,
  Sequence_Deploy = 27,
  Sequence_Deployed = 28,
  Sequence_DeployedFire = 29,
  Sequence_DeployedIdle = 30,
  Sequence_Undeploy = 31,
  Sequence_Cheer = 32,
  Sequence_Paradrop = 33,
  Sequence_AirDeathStart = 34,
  Sequence_AirDeathFalling = 35,
  Sequence_AirDeathFinish = 36,
  Sequence_Panic = 37,
  Sequence_Shovel = 38,
  Sequence_Carry = 39,
  Sequence_SecondaryFire = 40,
  Sequence_SecondaryProne = 41,
  Sequence_Nothing = -1
};

enum PipIndex : unsigned int
{
  PipIndex_Empty = 0,
  PipIndex_Green = 1,
  PipIndex_Yellow = 2,
  ...
  PipIndex_Red = 4,
  PipIndex_Blue = 5,
  PipIndex_PersonEmpty = 6,
  PipIndex_PersonGreen = 7,
  PipIndex_PersonYellow = 8,
  PipIndex_PersonWhite = 9,
  PipIndex_PersonRed = 10,
  PipIndex_PersonBlue = 11,
  PipIndex_PersonPurple = 12
};

enum SequenceFacing : __int32
{
  SequenceFacing_N = 0x0,
  SequenceFacing_NE = 0x1,
  SequenceFacing_E = 0x2,
  SequenceFacing_SE = 0x3,
  SequenceFacing_S = 0x4,
  SequenceFacing_SW = 0x5,
  SequenceFacing_W = 0x6,
  SequenceFacing_NW = 0x7,
};

enum RadBeamType : unsigned int
{
  RadBeamType_Temporal = 0,
  RadBeamType_RadBeam = 1,
  RadBeamType_Eruption = 2
};

enum GameMode : unsigned int
{
  GameMode_Campaign = 0x0,
  GameMode_LAN = 0x3,
  GameMode_Internet = 0x4,
  GameMode_Skirmish = 0x5,
};

enum RadarEventType : int
{
  RadarEventType_Combat = 0,
  RadarEventType_Noncombat = 1,
  RadarEventType_DropZone = 2,
  RadarEventType_BaseAttacked = 3,
  RadarEventType_HarvesterAttacked = 4,
  RadarEventType_EnemySensed = 5,
  RadarEventType_UnitProduced = 6,
  RadarEventType_UnitLost = 7,
  RadarEventType_UnitRepaired = 8,
  RadarEventType_BuildingInfiltrated = 9,
  RadarEventType_BuildingCaptured = 10,
  RadarEventType_BeaconPlaced = 11,
  RadarEventType_SuperweaponDetected = 12,
  RadarEventType_SuperweaponActivated = 13,
  RadarEventType_BridgeRepaired = 14,
  RadarEventType_GarrisonAbandoned = 15,
  RadarEventType_AllyBaseAttacked = 16
};

enum VoxType : __int32
{
  VoxType_Standard = 0x0,
  VoxType_Queue = 0x1,
  VoxType_Interrupt = 0x2,
  VoxType_QueuedInterrupt = 0x3,
};

enum VoxPriority : int
{
  VoxPriority_Low = 0,
  VoxPriority_Normal = 1,
  VoxPriority_Important = 2,
  VoxPriority_Critical = 3
};

enum Powerup : unsigned int
{
  Powerup_Money = 0,
  Powerup_Unit = 1,
  Powerup_HealBase = 2,
...
{
  JumpjetLocomotionClass_State_Grounded = 0,
  JumpjetLocomotionClass_State_Ascending = 1,
  JumpjetLocomotionClass_State_Hovering = 2,
  JumpjetLocomotionClass_State_Cruising = 3,
  JumpjetLocomotionClass_State_Descending = 4,
  JumpjetLocomotionClass_State_Crashing = 5,
  JumpjetLocomotionClass_State_Unknown = 6,
};

enum TunnelLocomotionClass_State
{
  TunnelLocomotionClass_State_Idle = 0,
  TunnelLocomotionClass_State_PreDigIn = 1,
  TunnelLocomotionClass_State_DiggingIn = 2,
  TunnelLocomotionClass_State_DugIn = 3,
  TunnelLocomotionClass_State_Digging = 4,
  TunnelLocomotionClass_State_PreDigOut = 5,
  TunnelLocomotionClass_State_DiggingOut = 6,
  TunnelLocomotionClass_State_DugOut = 7
};

enum ChargeDrainState : int
{
  ChargeDrainState_None = -1,
  ChargeDrainState_Charging = 0,
  ChargeDrainState_Ready = 1,
  ChargeDrainState_Draining = 2
};

enum LoadOptionsMode : unsigned int
{
  LoadOptionsMode_None = 0,
  LoadOptionsMode_Load = 1,
  LoadOptionsMode_Save = 2,
  LoadOptionsMode_Delete = 3
};

enum AbstractTypeE : unsigned __int8
{
  AbstractTypeE_None = 0x0,
  AbstractTypeE_Unit = 0x1,
  AbstractTypeE_Aircraft = 0x2,
  AbstractTypeE_AircraftType = 0x3,
  AbstractTypeE_Anim = 0x4,
  AbstractTypeE_AnimType = 0x5,
  AbstractTypeE_Building = 0x6,
  AbstractTypeE_BuildingType = 0x7,
  AbstractTypeE_Bullet = 0x8,
  AbstractTypeE_BulletType = 0x9,
  AbstractTypeE_Campaign = 0xA,
  AbstractTypeE_Cell = 0xB,
  AbstractTypeE_Factory = 0xC,
  AbstractTypeE_House = 0xD,
  AbstractTypeE_HouseType = 0xE,
  AbstractTypeE_Infantry = 0xF,
  AbstractTypeE_InfantryType = 0x10,
  AbstractTypeE_Isotile = 0x11,
  AbstractTypeE_IsotileType = 0x12,
  AbstractTypeE_BuildingLight = 0x13,
  AbstractTypeE_Overlay = 0x14,
  AbstractTypeE_OverlayType = 0x15,
  AbstractTypeE_Particle = 0x16,
  AbstractTypeE_ParticleType = 0x17,
  AbstractTypeE_ParticleSystem = 0x18,
  AbstractTypeE_ParticleSystemType = 0x19,
  AbstractTypeE_Script = 0x1A,
  AbstractTypeE_ScriptType = 0x1B,
  AbstractTypeE_Side = 0x1C,
  AbstractTypeE_Smudge = 0x1D,
  AbstractTypeE_SmudgeType = 0x1E,
  AbstractTypeE_Special = 0x1F,
  AbstractTypeE_SuperWeaponType = 0x20,
  AbstractTypeE_TaskForce = 0x21,
  AbstractTypeE_Team = 0x22,
  AbstractTypeE_TeamType = 0x23,
  AbstractTypeE_Terrain = 0x24,
  AbstractTypeE_TerrainType = 0x25,
  AbstractTypeE_Trigger = 0x26,
  AbstractTypeE_TriggerType = 0x27,
  AbstractTypeE_UnitType = 0x28,
  AbstractTypeE_VoxelAnim = 0x29,
  AbstractTypeE_VoxelAnimType = 0x2A,
  AbstractTypeE_Wave = 0x2B,
  AbstractTypeE_Tag = 0x2C,
  AbstractTypeE_TagType = 0x2D,
  AbstractTypeE_Tiberium = 0x2E,
  AbstractTypeE_Action = 0x2F,
  AbstractTypeE_Event = 0x30,
  AbstractTypeE_WeaponType = 0x31,
  AbstractTypeE_WarheadType = 0x32,
  AbstractTypeE_Waypoint = 0x33,
  AbstractTypeE_Abstract = 0x34,
  AbstractTypeE_Tube = 0x35,
  AbstractTypeE_LightSource = 0x36,
  AbstractTypeE_EMPulse = 0x37,
  AbstractTypeE_TacticalMap = 0x38,
  AbstractTypeE_Super = 0x39,
  AbstractTypeE_AITrigger = 0x3A,
  AbstractTypeE_AITriggerType = 0x3B,
  AbstractTypeE_Neuron = 0x3C,
  AbstractTypeE_FoggedObject = 0x3D,
  AbstractTypeE_AlphaShape = 0x3E,
  AbstractTypeE_VeinholeMonster = 0x3F,
  AbstractTypeE_NavyType = 0x40,
  AbstractTypeE_SpawnManager = 0x41,
  AbstractTypeE_CaptureManager = 0x42,
  AbstractTypeE_Parasite = 0x43,
  AbstractTypeE_Bomb = 0x44,
  AbstractTypeE_RadSite = 0x45,
  AbstractTypeE_Temporal = 0x46,
  AbstractTypeE_Airstrike = 0x47,
  AbstractTypeE_SlaveManager = 0x48,
  AbstractTypeE_DiskLaser = 0x49,
};

enum MissionE : unsigned __int8
{
  MissionE_None = -1,
  MissionE_Sleep = 0,
  MissionE_Attack = 1,
  ...
  MissionE_Eaten = 9,
  MissionE_Harvest = 10,
  MissionE_Area_Guard = 11,
  MissionE_Return = 12,
  MissionE_Stop = 13,
  MissionE_Ambush = 14,
  MissionE_Hunt = 15,
  MissionE_Unload = 16,
  MissionE_Sabotage = 17,
  MissionE_Construction = 18,
  MissionE_Selling = 19,
  MissionE_Repair = 20,
  MissionE_Rescue = 21,
  MissionE_Missile = 22,
  MissionE_Harmless = 23,
  MissionE_Open = 24,
  MissionE_Patrol = 25,
  MissionE_ParadropApproach = 26,
  MissionE_ParadropOverfly = 27,
  MissionE_Wait = 28,
  MissionE_AttackMove = 29,
  MissionE_SpyplaneApproach = 30,
  MissionE_SpyplaneOverfly = 31
};

enum TextPrintType : __int32
{
  LASTPOINT = 0x0,
  LASTSHADOW = 0x0,
  Point6 = 0x1,
...
union Union_D_D_PIXEL_FORMAT_dw3
{
  ...
  SUR_D_D_PIXEL_FORMAT_unnamed_tag_u_type_MultiSampleCaps MultiSampleCaps;
};
...
struct SUR_D_D_PIXEL_FORMAT
{
  ...
  Union_D_D_PIXEL_FORMAT_dw1 D_D_PIXEL_FORMAT_dw1;
  Union_D_D_PIXEL_FORMAT_dw2 D_D_PIXEL_FORMAT_dw2;
  Union_D_D_PIXEL_FORMAT_dw3 D_D_PIXEL_FORMAT_dw3;
  Union_D_D_PIXEL_FORMAT_dw4 D_D_PIXEL_FORMAT_dw4;
  Union_D_D_PIXEL_FORMAT_dw5 D_D_PIXEL_FORMAT_dw5;
};

union Union_DDD_D_SURFACE_DESC2_D_D_PIXEL_FORMAT
{
  SUR_D_D_PIXEL_FORMAT ddpfPixelFormat;
  unsigned int dwFVF;
};
...
union Union_DDD_D_SURFACE_DESC2_D_D_COLOR_KEY
{
  SUR_D_D_COLOR_KEY ddckCKDestOverlay;
...
struct SUR_D_D_SURFACE_DESC2
{
  ...
  Union_DDD_D_SURFACE_DESC2_lPitch DDD_D_SURFACE_DESC2_lPitch;
  unsigned int dwBackBufferCount;
  Union_DDD_D_SURFACE_DESC2_dw DDD_D_SURFACE_DESC2_dw;
  unsigned int dwAlphaBitDepth;
  unsigned int dwReserved;
  void *lpSurface;
  Union_DDD_D_SURFACE_DESC2_D_D_COLOR_KEY DDD_D_SURFACE_DESC2_D_D_COLOR_KEY;
  SUR_D_D_COLOR_KEY ddckCKDestBlt;
  SUR_D_D_COLOR_KEY ddckCKSrcOverlay;
  SUR_D_D_COLOR_KEY ddckCKSrcBlt;
  Union_DDD_D_SURFACE_DESC2_D_D_PIXEL_FORMAT DDD_D_SURFACE_DESC2_D_D_PIXEL_FORMAT;
  SUR_D_D_SCAPS2 ddsCaps;
...
union Union_Large_Int
{
  Large_Int_unnamed_type_s type_s;
  Large_Int_unnamed_type_u type_u;
  __int64 QuadPart;
};

union Union_U_Large_Int
{
  U_Large_Int_unnamed_type_s type_s;
  U_Large_Int_unnamed_type_u type_u;
...
typedef Vector2D_short CellStruct;
...
struct VocClass
{
  ...
  unsigned int unknown_90;
  unsigned int unknown_94;
  unsigned int unknown_98;
  unsigned int unknown_9C;
  unsigned int unknown_A0;
  ...
  int Attack;
  int Decay;
  unsigned int unknown_140;
  unsigned int unknown_144;
};
...
struct __declspec(align(4)) MemoryBuffer
{
  void *Buffer;
  int Size;
  bool Allocated;
...
struct Matrix3D
{
  Union_Matrix3D_Vector4D Matrix3D_Vector4D;
};

struct __declspec(align(4)) VoxelSectionHeader
{
  int limb_number;
  int unk1;
  char unk2;
...
{
  bool Initialized;
  unsigned int CountHeaders;
  unsigned int CountTailers;
  unsigned int TotalSize;
  VoxelSectionHeader *HeaderData;
  VoxelSectionTailer *TailerData;
  unsigned __int8 *BodyData;
};
...
struct MainVoxelIndexKey
{
  unsigned __int32 FrameIndex : 5;
  unsigned __int32 RampType : 5;
  unsigned __int32 bitfield_10 : 6;
  unsigned __int32 UseAuxVoxel : 1;
...
struct TurretWeaponVoxelIndexKey
{
  unsigned __int32 Facing : 5;
  unsigned __int32 HasTurretOffset : 5;
  unsigned __int32 bitfield_10 : 6;
  unsigned __int32 FrameIndex : 8;
...
struct BounceClass
{
  ...
  long double Gravity;
  long double MaxVelocity;
  Vector3D_float Coords;
  Vector3D_float Velocity;
...
struct ReservedVoxelIndexKey
{
  unsigned __int32 bitfield_0 : 10;
  unsigned __int32 ReservedIndex : 6;
  unsigned __int32 bitfield_16 : 16;
};
...
struct __declspec(align(4)) RadarEventClass
{
  RadarEventType Type;
  int RadarX;
  int RadarY;
...
struct Theater
{
  char ID[16];
  char UIName[32];
  char ControlFileName[10];
  char ArtFileName[10];
  char PaletteFileName[10];
  char Extension[4];
  char MMExtension[4];
  char Letter[2];
  float RadarTerrainBrightness;
...
struct DifficultyStruct
{
  long double Firepower;
  long double GroundSpeed;
  long double AirSpeed;
  long double Armor;
  long double ROF;
  long double Cost;
  long double BuildTime;
  long double RepairDelay;
  long double BuildDelay;
  bool BuildSlowdown;
  bool DestroyWalls;
  bool ContentScan;
...
class ConvertClass
{
  ...
  int BytesPerPixel;
  struct Blitter *Blitters[50];
  struct RLEBlitter *RLEBlitters[39];
  int ShadeCount;
  void *FullColorData;
  void *PaletteData;
  void *ByteColorData;
  unsigned int CurrentZRemap;
  unsigned int HalfTranslucencyMask;
  unsigned int QuatTranslucencyMask;
};
...
class LightConvertClass : ConvertClass
{
  ...
  unsigned __int8 *IndexesToIgnore;
  int RefCount;
  TintStruct Color1;
  TintStruct Color2;
  bool Tinted;
...
struct ColorScheme
{
  ...
  int ShadeCount;
  unsigned __int8 unknown_314[28];
  int MainShadeIndex;
...
union Union_In_addr_unnamed_type_un
{
  In_addr_unnamed_type_un_u_b S_un_b;
  In_addr_unnamed_type_un_u_w S_un_w;
  unsigned int S_addr;
};

struct In_addr
{
  Union_In_addr_unnamed_type_un S_un;
};
...
struct __declspec(align(4)) Tag_WIN32_FIND_DATAA
{
  unsigned int dwFileAttributes;
  Tag_FILETIME ftCreationTime;
  Tag_FILETIME ftLastAccessTime;
  Tag_FILETIME ftLastWriteTime;
...
class RawFileClass : FileClass
{
  ...
  void *Handle;
  char *FileName;
  __int16 unknown_short_1C;
  __int16 unknown_short_1E;
...
struct __unaligned __declspec(align(1)) NodeNameType
{
  wchar_t Name[20];
  sockaddr_in Address;
  char Serial[19];
  ...
  int Team;
  int InitialTeam;
  unsigned int SpectatorFlag;
  int HouseIndex;
  int Time;
  unsigned int unknown_int_77;
  int Clan;
  unsigned int unknown_int_7F;
  unsigned __int8 unknown_byte_83;
...
struct INoticeSource
{
  INoticeSource_vtbl *__vftable;
};

struct INoticeSource_vtbl
{
...
struct IHouse_vtbl
{
  ...
  int (__stdcall *Available_Money)(IHouse *this);
...
struct IFlyControl_vtbl
{
  ...
  int (__stdcall *Is_Strafe)(IFlyControl *this);
  int (__stdcall *Is_Fighter)(IFlyControl *this);
...
{
  DynamicVectorClass_SwizzlePointerClass Swizzles_Old;
...
struct ILocomotion_vtbl
{
  ...
  FireError (__stdcall *Can_Fire)(ILocomotion *this);
  ...
  void (__stdcall *Limbo)(ILocomotion *this);
  void (__stdcall *Lock)(ILocomotion *this);
  void (__stdcall *Unlock)(ILocomotion *this);
  int (__stdcall *Get_Track_Number)(ILocomotion *this);
  int (__stdcall *Get_Track_Index)(ILocomotion *this);
...
struct __unaligned __declspec(align(4)) PlanningTokenClass
{
  ...
  DynamicVectorClass_PlanningNodeClass_PTR PlanningNodes;
  bool field_1C;
  bool field_1D;
  __declspec(align(4)) Union_PlanningTokenClass_unknown_20_88 ___u4;
  int field_8C;
...
struct RadBeam
{
  ...
  long double unknown_B8;
  unsigned __int8 unknown_C0;
  unsigned int unknown_C4;
};

struct __declspec(align(4)) EBolt
{
  CoordStruct Point1;
  CoordStruct Point2;
  unsigned int unknown_18;
...
struct LaserDrawClass
{
  ...
  unsigned __int8 align_4A[2];
  int Duration;
  bool Blinks;
  bool BlinkState;
  bool Fades;
  unsigned __int8 align_53;
...
class MPGameModeClass
{
  ...
  bool unknown_4;
  DynamicVectorClass_MPTeam_PTR MPTeams;
  Union_MPGameModeClass_CSFTitle MPGameModeClass_CSFTitle;
  Union_MPGameModeClass_CSFTooltip MPGameModeClass_CSFTooltip;
  int MPModeIndex;
  Union_MPGameModeClass_INIFilename MPGameModeClass_INIFilename;
  Union_MPGameModeClass_MapFilter MPGameModeClass_MapFilter;
  bool AIAllowed;
  CCINIClass *INI;
  bool AlliesAllowed;
  bool wolTourney;
...
struct __declspec(align(4)) SessionClass
{
  GameMode GameMode;
  ...
  char Handle[20];
  int PlayerColor;
  unsigned int unknown_160;
  unsigned int unknown_164;
  unsigned int unknown_168;
  unsigned int unknown_16C;
  unsigned int unknown_170;
  int idxSide;
  int idxSide2;
  int Color;
  int Color2;
  ...
  int MultiplayerObserver;
  unsigned int Unknown_304;
...
struct __declspec(align(8)) RulesClass
{
  ...
  long double TunnelSpeed;
  long double TiberiumHeal;
  ...
  TypeList_VoxelAnimTypeClass_PTR BarrelDebris;
  ...
  long double AITriggerSuccessWeightDelta;
  long double AITriggerFailureWeightDelta;
  long double AITriggerTrackRecordCoefficient;
  ...
  TypeList_AnimTypeClass_PTR DropPod;
  TypeList_AnimTypeClass_PTR DeadBodies;
  TypeList_AnimTypeClass_PTR MetallicDebris;
  TypeList_AnimTypeClass_PTR BridgeExplosions;
  int DigSound;
  int CreateUnitSound;
  ...
  TypeList_AnimTypeClass_PTR DamageFireTypes;
  TypeList_AnimTypeClass_PTR WeatherConClouds;
  TypeList_AnimTypeClass_PTR WeatherConBolts;
  ...
  TypeList_int PrerequisitePower;
  TypeList_int PrerequisiteFactory;
  TypeList_int PrerequisiteBarracks;
  TypeList_int PrerequisiteRadar;
  TypeList_int PrerequisiteTech;
  TypeList_int PrerequisiteProc;
  ...
  long double WobblesPerSecond;
  int WobbleDeviation;
  TypeList_int RadarEventSuppressionDistances;
  TypeList_int RadarEventVisibilityDurations;
  TypeList_int RadarEventDurations;
  int IonCannonDamage;
  ...
  RocketStruct CMisl;
  int ParadropRadius;
  long double ZoomInFactor;
  long double ConditionRedSparkingProbability;
  long double ConditionYellowSparkingProbability;
  ...
  long double TreeFlammability;
  long double MissileSpeedVar;
  long double MissileROTVar;
  int MissileSafetyAltitude;
  WeaponTypeClass *DropPodWeapon;
  int DropPodHeight;
  int DropPodSpeed;
  long double DropPodAngle;
  long double ScrollMultiplier;
  long double CrewEscape;
  int ShakeScreen;
  int HoverHeight;
  long double HoverBob;
  long double HoverBoost;
  long double HoverAcceleration;
  long double HoverBrake;
  long double HoverDampen;
  long double PlacementDelay;
  TypeList_VoxelAnimTypeClass_PTR ExplosiveVoxelDebris;
  VoxelAnimTypeClass *TireVoxelDebris;
  VoxelAnimTypeClass *ScrapVoxelDebris;
  int BridgeVoxelMax;
  int CloakingStages;
  int RevealTriggerRadius;
  long double ShipSinkingWeight;
  long double IceCrackingWeight;
  long double IceBreakingWeight;
  TypeList_int IceCrackSounds;
  unsigned __int8 CliffBackImpassability;
  long double VeteranRatio;
  long double VeteranCombat;
  long double VeteranSpeed;
  long double VeteranSight;
  long double VeteranArmor;
  long double VeteranROF;
  long double VeteranCap;
  int CloakSound;
  int SellSound;
  int GameClosed;
  int IncomingMessage;
  ...
  int DeploySound;
  int StormSound;
  TypeList_int LightningSounds;
  int ShellButtonSlideSound;
  long double WallBuildSpeedCoefficient;
  long double ChargeToDrainRatio;
  long double TrackedUphill;
  long double TrackedDownhill;
  long double WheeledUphill;
  long double WheeledDownhill;
  int SpotlightMovementRadius;
  int SpotlightLocationRadius;
  long double SpotlightSpeed;
  long double SpotlightAcceleration;
  long double SpotlightAngle;
  int SpotlightRadius;
  int WindDirection;
  int CameraRange;
  int FlightLevel;
  ...
  int BuildingDrop;
  TypeList_SmudgeTypeClass_PTR Scorches;
  TypeList_SmudgeTypeClass_PTR Scorches1;
  TypeList_SmudgeTypeClass_PTR Scorches2;
  TypeList_SmudgeTypeClass_PTR Scorches3;
  TypeList_SmudgeTypeClass_PTR Scorches4;
  TypeList_BuildingTypeClass_PTR RepairBay;
  ...
  TypeList_BuildingTypeClass_PTR Shipyard;
  ...
  TypeList_BuildingTypeClass_PTR BuildConst;
  TypeList_BuildingTypeClass_PTR BuildPower;
  TypeList_BuildingTypeClass_PTR BuildRefinery;
  TypeList_BuildingTypeClass_PTR BuildBarracks;
  TypeList_BuildingTypeClass_PTR BuildTech;
  TypeList_BuildingTypeClass_PTR BuildWeapons;
  TypeList_BuildingTypeClass_PTR AlliedBaseDefenses;
  TypeList_BuildingTypeClass_PTR SovietBaseDefenses;
  TypeList_BuildingTypeClass_PTR ThirdBaseDefenses;
  TypeList_int AIForcePredictionFudge;
  TypeList_BuildingTypeClass_PTR BuildDefense;
  TypeList_BuildingTypeClass_PTR BuildPDefense;
  TypeList_BuildingTypeClass_PTR BuildAA;
  TypeList_BuildingTypeClass_PTR BuildHelipad;
  TypeList_BuildingTypeClass_PTR BuildRadar;
  TypeList_BuildingTypeClass_PTR ConcreteWalls;
  TypeList_BuildingTypeClass_PTR NSGates;
  TypeList_BuildingTypeClass_PTR EWGates;
  TypeList_BuildingTypeClass_PTR BuildNavalYard;
  TypeList_BuildingTypeClass_PTR BuildDummy;
  TypeList_BuildingTypeClass_PTR NeutralTechBuildings;
  long double GDIWallDefense;
  long double GDIWallDefenseCoefficient;
  long double NodBaseDefenseCoefficient;
  long double GDIBaseDefenseCoefficient;
  int ComputerBaseDefenseResponse;
  int MaximumBaseDefenseValue;
  TypeList_UnitTypeClass_PTR BaseUnit;
  TypeList_UnitTypeClass_PTR HarvesterUnit;
  TypeList_AircraftTypeClass_PTR PadAircraft;
  TypeList_AnimTypeClass_PTR OnFire;
  TypeList_AnimTypeClass_PTR TreeFire;
  AnimTypeClass *Smoke;
  AnimTypeClass *Smoke_;
  AnimTypeClass *MoveFlash;
  AnimTypeClass *BombParachute;
  AnimTypeClass *Parachute;
  TypeList_AnimTypeClass_PTR SplashList;
  ...
  TypeList_InfantryTypeClass_PTR AmerParaDropInf;
  TypeList_int AmerParaDropNum;
  TypeList_InfantryTypeClass_PTR AllyParaDropInf;
  TypeList_int AllyParaDropNum;
  TypeList_InfantryTypeClass_PTR SovParaDropInf;
  TypeList_int SovParaDropNum;
  TypeList_InfantryTypeClass_PTR YuriParaDropInf;
  TypeList_int YuriParaDropNum;
  TypeList_InfantryTypeClass_PTR AnimToInfantry;
  TypeList_InfantryTypeClass_PTR SecretInfantry;
  TypeList_UnitTypeClass_PTR SecretUnits;
  TypeList_BuildingTypeClass_PTR SecretBuildings;
  int SecretSum;
  ...
  TypeList_int AlliedBaseDefenseCounts;
  TypeList_int SovietBaseDefenseCounts;
  TypeList_int ThirdBaseDefenseCounts;
  TypeList_int AIPickWallDefensePercent;
  ...
  TypeList_int DisabledDisguiseDetectionPercent;
  TypeList_int AIAutoDeployFrameDelay;
  int MaximumBuildingPlacementFailures;
  TypeList_int AICaptureNormal;
  TypeList_int AICaptureWounded;
  TypeList_int AICaptureLowPower;
  TypeList_int AICaptureLowMoney;
  int AICaptureLowMoneyMark;
  int AICaptureWoundedMark;
  TypeList_int AISuperDefenseProbability;
  int AISuperDefenseFrames;
  float AISuperDefenseDistance;
  TypeList_int OverloadCount;
  TypeList_int OverloadDamage;
  TypeList_int OverloadFrames;
  float PurifierBonus;
  ...
  TypeList_TerrainTypeClass_PTR DefaultMirageDisguises;
  ...
  long double MyEffectivenessCoefficientDefault;
  long double TargetEffectivenessCoefficientDefault;
  long double TargetSpecialThreatCoefficientDefault;
  long double TargetStrengthCoefficientDefault;
  long double TargetDistanceCoefficientDefault;
  long double DumbMyEffectivenessCoefficient;
  long double DumbTargetEffectivenessCoefficient;
  long double DumbTargetSpecialThreatCoefficient;
  long double DumbTargetStrengthCoefficient;
  long double DumbTargetDistanceCoefficient;
  long double EnemyHouseThreatBonus;
  long double TurboBoost;
  long double AttackInterval;
  long double AttackDelay;
  long double PowerEmergency;
  long double AirstripRatio;
  int AirstripLimit;
  long double HelipadRatio;
  int HelipadLimit;
  long double TeslaRatio;
  int TeslaLimit;
  long double AARatio;
  int AALimit;
  long double DefenseRatio;
  int DefenseLimit;
  long double WarRatio;
  int WarLimit;
  long double BarracksRatio;
  int BarracksLimit;
  int RefineryLimit;
  long double RefineryRatio;
  int BaseSizeAdd;
  int PowerSurplus;
  int InfantryReserve;
  ...
  long double PatrolScan;
  TypeList_int TeamDelays;
  TypeList_int AIHateDelays;
  int DissolveUnfilledTeamDelay;
  TypeList_int AIIonCannonConYardValue;
  TypeList_int AIIonCannonWarFactoryValue;
  TypeList_int AIIonCannonPowerValue;
  TypeList_int AIIonCannonTechCenterValue;
  TypeList_int AIIonCannonEngineerValue;
  TypeList_int AIIonCannonThiefValue;
  TypeList_int AIIonCannonHarvesterValue;
  TypeList_int AIIonCannonMCVValue;
  TypeList_int AIIonCannonAPCValue;
  TypeList_int AIIonCannonBaseDefenseValue;
  TypeList_int AIIonCannonPlugValue;
  TypeList_int AIIonCannonHelipadValue;
  TypeList_int AIIonCannonTempleValue;
  int AIAlternateProductionCreditCutoff;
  TypeList_int MultiplayerAICM;
  TypeList_int AIVirtualPurifiers;
  TypeList_int AISlaveMinerNumber;
  TypeList_int HarvestersPerRefinery;
  TypeList_int AIExtraRefineries;
  TypeList_int MinimumAIDefensiveTeams;
  TypeList_int MaximumAIDefensiveTeams;
  TypeList_int TotalAITeamCap;
  long double AIUseTurbineUpgradeProbability;
  TypeList_int FillEarliestTeamProbability;
  long double CloakDelay;
  long double GameSpeedBias;
  long double BaseBias;
  long double ExpSpread;
  int FireSupress;
  int MaxIQLevels;
  int SuperWeapons;
  int Production;
  ...
  int DropZoneRadius;
  long double MessageDelay;
  long double SavourDelay;
  int Players;
  long double BaseDefenseDelay;
  int SuspendPriority;
  long double SuspendDelay;
  long double SurvivorRate;
  int AlliedSurvivorDivisor;
  int SovietSurvivorDivisor;
  int ThirdSurvivorDivisor;
  long double ReloadRate;
  long double AutocreateTime;
  long double BuildupTime;
  int HarvesterLoadRate;
  long double HarvesterDumpRate;
  int AtomDamage;
  DifficultyStruct Easy;
  DifficultyStruct Normal;
  DifficultyStruct Difficult;
  unsigned int align_1628[4];
  long double GrowthRate;
  long double ShroudRate;
  long double FogRate;
  long double IceGrowthRate;
  long double VeinGrowthRate;
  int IceSolidifyFrameTime;
  long double AmbientChangeRate;
  long double AmbientChangeStep;
  long double CrateRegen;
  long double TimerWarning;
  int TiberiumTransmogrify;
  long double unknown_double_1690;
  long double unknown_double_1698;
  long double unknown_double_16A0;
  long double SpeakDelay;
  long double DamageDelay;
  int Gravity;
  ...
  int MaxDamage;
  int RepairStep;
  long double RepairPercent;
  int IRepairStep;
  long double RepairRate;
  long double URepairRate;
  long double IRepairRate;
  long double unknown_double_16F8;
  long double ConditionYellow;
  long double ConditionRed;
  long double IdleActionFrequency;
  int CloseEnough;
  int Stray;
  int RelaxedStray;
  int GuardModeStray;
  ...
  long double RefundPercent;
  int BridgeStrength;
  long double BuildSpeed;
  long double C4Delay;
  int CreditReserve;
  long double PathDelay;
  int BlockagePathDelay;
  long double MovieTime;
  ...
  int RadLevelDelay;
  int RadLightDelay;
  long double RadLevelFactor;
  long double RadLightFactor;
  long double RadTintFactor;
  ColorStruct RadColor;
  WarheadTypeClass *RadSiteWarhead;
  int ElevationIncrement;
  long double ElevationIncrementBonus;
  long double ElevationBonusCap;
  bool AlliedWallTransparency;
  long double WallPenetratorThreshold;
...
struct __declspec(align(8)) ScenarioClass
{
  ...
  TypeList_TechnoTypeClass_PTR AllowableUnits;
  TypeList_int AllowableUnitMaximums;
  TypeList_int DropshipUnitCounts;
  int AmbientOriginal;
  int AmbientCurrent;
  int AmbientTarget;
...
class TriggerClass : AbstractClass
{
  ...
  HouseClass *House;
  bool Destroyed;
  unsigned __int8 align_31[3];
  CDTimerClass Timer;
  unsigned int OccuredEvents;
  bool Enabled;
...
class HouseClass : AbstractClass, IHouse, IPublicHouse, IConnectionPointContainer
{
  ...
  long double AirspeedMultiplier;
  long double ArmorMultiplier;
  long double ROFMultiplier;
  long double CostMultiplier;
  long double BuildTimeMultiplier;
  long double RepairDelay;
  long double BuildDelay;
  int IQLevel;
  int TechLevel;
  ...
  WaypointPathClass *PlanningPaths[12];
  char Visionary;
  bool MapIsClear;
  ...
  unsigned int InfantryAltOwner;
  unsigned int UnitAltOwner;
  unsigned int AircraftAltOwner;
  unsigned int BuildingAltOwner;
  int AirportDocks;
  ...
  unsigned __int8 AircraftType_53D0;
  unsigned __int8 InfantryType_53D1;
  unsigned __int8 VehicleType_53D2;
  unsigned __int8 ShipType_53D3;
  unsigned __int8 BuildingType_53D4;
  unsigned __int8 unknown_53D5;
  unsigned __int8 unknown_53D6;
  unsigned __int8 unknown_53D7;
  unsigned __int8 DefenseType_53D8;
  ...
  int KilledBuildingsOfHouses[20];
  ...
  long double unused_16088;
  long double unused_16090;
  unsigned int padding_16098;
...
class HouseTypeClass : AbstractTypeClass
{
  ...
  int SideIndex;
  int ColorSchemeIndex;
  unsigned int align_C4;
  long double FirepowerMult;
  long double GroundspeedMult;
  long double AirspeedMult;
  long double ArmorMult;
  long double ROFMult;
  long double CostMult;
  long double BuildtimeMult;
  ...
  float IncomeMult;
  TypeList_InfantryTypeClass_PTR VeteranInfantry;
  TypeList_UnitTypeClass_PTR VeteranUnits;
  TypeList_AircraftTypeClass_PTR VeteranAircraft;
  char Suffix[4];
  char Prefix;
  bool Multiplay;
...
class ObjectClass : AbstractClass
{
  ...
  bool IsABomb;
  bool IsAlive;
  unsigned __int8 align_91[3];
  Layer LastLayer;
  bool IsInLogic;
  bool IsVisible;
  unsigned __int8 align_99[2];
  CoordStruct Location;
...
class __unaligned __declspec(align(4)) ObjectTypeClass : AbstractTypeClass
{
  ...
  SHPStruct *Image;
  bool ImageAllocated;
  unsigned __int8 align_A9[3];
  SHPStruct *AlphaImage;
  VoxelStruct MainVoxel;
  VoxelStruct TurretVoxel;
  VoxelStruct BarrelVoxel;
  VoxelStruct ChargerTurrets[18];
  VoxelStruct ChargerBarrels[18];
  bool NoSpawnAlt;
  unsigned __int8 align_1E9[3];
  int MaxDimension;
  int CrushSound;
  int AmbientSound;
  char ImageFile[25];
...
struct ObjectTypeClass_vtbl
{
  ...
  void (__thiscall *Dimension2)(ObjectTypeClass *this, CoordStruct *);
...
class __declspec(align(4)) AnimTypeClass : ObjectTypeClass
{
  ...
  long double Elasticity;
  long double MinZVel;
  long double unknown_double_320;
  long double MaxXYVel;
...
class SuperClass : AbstractClass
{
  ...
  bool BlinkState;
  unsigned __int8 unused_41[7];
  Union_Large_Int BlinkTimer;
  int SpecialSoundDuration;
  CoordStruct SpecialSoundLocation;
  bool CanHold;
  unsigned __int8 unused_61;
  CellStruct ChronoMapCoords;
  unsigned __int8 unused_66[2];
  AnimClass *Animation;
...
class SuperWeaponTypeClass : AbstractTypeClass
{
  ...
  char SidebarImageFile[24];
  unsigned __int8 zero_E4;
  bool UseChargeDrain;
  bool IsPowered;
...
class __unaligned __declspec(align(4)) ScriptTypeClass : AbstractTypeClass
{
  int ArrayIndex;
  bool IsGlobal;
  __declspec(align(4)) int ActionsCount;
...
class TActionClass : AbstractClass
{
  ...
  struct TriggerTypeClass *TriggerType;
  char TechnoID[25];
  char Text[32];
  unsigned __int8 align_8D[3];
  int Value;
};
...
class AirstrikeClass : AbstractClass
{
  ...
  int AirstrikeTeamTypeIndex;
  int EliteAirstrikeTeamTypeIndex;
  unsigned int unknown_34;
  unsigned int unknown_38;
  bool IsOnMission;
  bool unknown_bool_3D;
  unsigned int TeamDissolveFrame;
...
class AITriggerTypeClass : AbstractTypeClass
{
  ...
  int TechLevel;
  int unknown_B4;
  long double Weight_Current;
  long double Weight_Minimum;
  long double Weight_Maximum;
  bool IsForSkirmish;
...
class TiberiumClass : AbstractTypeClass
{
  int ArrayIndex;
  int Spread;
  long double SpreadPercentage;
  int Growth;
  long double GrowthPercentage;
  int Value;
  int Power;
  int Color;
...
{
  long double Deform;
  long double Verses[11];
  long double ProneDamage;
  int DeformTreshold;
  TypeList_AnimTypeClass_PTR AnimList;
  InfDeath InfDeath;
  float CellSpread;
  float CellInset;
  float PercentAtMax;
...
class ParticleClass : ObjectClass
{
  ...
  unsigned __int8 unknown_B1;
  unsigned __int8 unknown_B2;
  unsigned int unknown_B4;
  unsigned int unknown_B8;
  unsigned int unknown_BC;
  CoordStruct Velocity;
  unsigned int unknown_CC;
  long double unknown_double_D0;
  unsigned int unknown_D8;
  unsigned int unknown_DC;
  unsigned int unknown_E0;
  float Speed;
  CoordStruct unknown_coords_E8;
  CoordStruct unknown_coords_F4;
  CoordStruct unknown_coords_100;
  Vector3D_float unknown_vector3d_10C;
  Vector3D_float unknown_vector3d_118;
  ParticleSystemClass *ParticleSystem;
  unsigned __int16 RemainingEC;
  unsigned __int16 RemainingDC;
  unsigned __int8 StateAIAdvance;
  unsigned __int8 unknown_12D;
  unsigned __int8 StartStateAI;
  unsigned __int8 Translucency;
  unsigned __int8 unknown_130;
  unsigned __int8 unknown_131;
...
class ParticleTypeClass : ObjectTypeClass
{
  ...
  int MinZVelocity;
  int ZVelocityRange;
  long double ColorSpeed;
  TypeList_RGBClass_PTR ColorList;
  ...
  unsigned __int8 EndStateAI;
  unsigned __int8 StartStateAI;
  unsigned __int8 StateAIAdvance;
  unsigned __int8 FinalDamageState;
...
class __declspec(align(4)) ParticleSystemTypeClass : ObjectTypeClass
{
  ...
  BehavesLike BehavesLike;
  int Lifetime;
  Vector3D_float SpawnDirection;
  long double ParticlesPerCoord;
  long double SpiralDeltaPerCoord;
  long double SpiralRadius;
  long double PositionPerturbationCoefficient;
  long double MovementPerturbationCoefficient;
  long double VelocityPerturbationCoefficient;
  long double SpawnSparkPercentage;
  int SparkSpawnFrames;
  int LightSize;
  ColorStruct LaserColor;
  bool Laser;
...
class BulletTypeClass : ObjectTypeClass
{
  ...
  bool Scalable;
  int Arm;
  unsigned __int8 AnimLow;
  unsigned __int8 AnimHigh;
  unsigned __int8 AnimRate;
  bool Flat;
};
...
class CellClass : AbstractClass
{
  ...
  unsigned int CloakedByHouses;
  unsigned __int16 SensorsOfHouses[24];
  unsigned __int16 DisguiseSensorsOfHouses[24];
  unsigned int BaseSpacerOfHouses;
  FootClass *Jumpjet;
  ObjectClass *FirstObject;
  ObjectClass *AltObject;
  LandType LandType;
  long double RadLevel;
  RadSiteClass *RadSite;
  struct PixelFXClass *PixelFX;
  int OccupyHeightsCoveringMe;
  unsigned int Intensity;
  unsigned __int16 Ambient;
  unsigned __int16 Intensity_Normal;
  unsigned __int16 Intensity_Terrain;
  unsigned __int16 Color1_Blue;
  unsigned __int16 Color2_Red;
  unsigned __int16 Color2_Green;
  unsigned __int16 Color2_Blue;
  __int16 TubeIndex;
  char unknown_118;
  char IsIceGrowthAllowed;
  char Height;
  char Level;
  unsigned __int8 SlopeIndex;
  unsigned __int8 unknown_11D;
  unsigned __int8 OverlayData;
  unsigned __int8 SmudgeData;
  char Visibility;
  char Foggedness;
  ...
  unsigned __int8 align_139[3];
  unsigned int unknown_13C;
  CellFlags Flags;
...
class WaveClass : ObjectClass
{
  ...
  int WaveEC;
  int WaveCount;
  long double MatrixScale1;
  long double MatrixScale2;
  int PointData_Counter;
  unsigned int PointData_Pointer;
  Point2D SonicPoints[6];
  Point2D MagPoints[4];
  int PointData2_X;
  int PointData2_Y;
  unsigned int PointData2_Pointer;
  int PitchData[8];
  int FacingIndex;
  int LaserEC;
  TechnoClass *Owner;
  FacingClass Facing;
  DynamicVectorClass_CellClass_PTR Cells;
  int ColorData[14];
};
...
class TechnoClass : RadioClass
{
  ...
  unsigned __int8 unused_273;
  TemporalClass *TemporalImUsing;
  TemporalClass *TemporalTargetingMe;
  bool IsImmobilized;
  unsigned int unknown_280;
  int ChronoLockRemaining;
  CoordStruct ChronoDestCoords;
  AirstrikeClass *Airstrike;
  bool Berzerk;
  unsigned int BerzerkDurationLeft;
  unsigned int SprayOffsetIndex;
  bool Uncrushable;
  ...
  HouseClass *MindControlledByHouse;
  ...
  __int16 unknown_short_3C8;
  unsigned __int16 unknown_3CA;
  bool CountedAsOwned;
  bool IsSinking;
  bool WasSinkingAlready;
  ...
  TechnoClass *BeingManipulatedBy;
...
struct TechnoClass_vtbl
{
  ...
  long double (__thiscall *GetStoragePercentage)(TechnoClass *this);
  ...
  unsigned int (__thiscall *vt_entry_464)(TechnoClass *this, unsigned int);
...
class TechnoTypeClass : ObjectTypeClass
{
  ...
  long double SpecialThreatValue;
  long double MyEffectivenessCoefficient;
  long double TargetEffectivenessCoefficient;
  long double TargetSpecialThreatCoefficient;
  long double TargetStrengthCoefficient;
  long double TargetDistanceCoefficient;
  ...
  TypeList_int DebrisMaximums;
  _GUID Locomotor;
  unsigned int align_35C;
  long double VoxelScaleX;
  long double VoxelScaleY;
  long double Weight;
  long double PhysicalSize;
  long double Size;
  long double SizeLimit;
  bool HoverAttack;
  int VHPScan;
  int unknown_int_398;
  unsigned int align_39C;
  long double RollAngle;
  long double PitchSpeed;
  long double PitchAngle;
  int BuildLimit;
  Category Category;
  unsigned int unknown_3C0;
  unsigned int align_3C4;
  long double DeployTime;
  int FireAngle;
  PipScale PipScale;
  bool PipsDrawForAll;
  ...
  int PipWrap;
  TypeList_BuildingTypeClass_PTR Dock;
  BuildingTypeClass *DeploysInto;
  UnitTypeClass *UndeploysInto;
  UnitTypeClass *PowersUnit;
  bool PoweredUnit;
  TypeList_int VoiceSelect;
  TypeList_int VoiceSelectEnslaved;
  TypeList_int VoiceSelectDeactivated;
  TypeList_int VoiceMove;
  TypeList_int VoiceAttack;
  TypeList_int VoiceSpecialAttack;
  TypeList_int VoiceDie;
  TypeList_int VoiceFeedback;
  TypeList_int MoveSound;
  TypeList_int DieSound;
  int AuxSound1;
  int AuxSound2;
  int CreateSound;
  int DamageSound;
  ...
  int EliteAirstrikeRechargeTime;
  int TechLevel;
  TypeList_int Prerequisite;
  TypeList_int PrerequisiteOverride;
  int ThreatPosed;
  int Points;
  int Speed;
  SpeedType SpeedType;
  ...
  char CameoFile[25];
  unsigned __int8 align_6EF;
  SHPStruct *Cameo;
  bool CameoAllocated;
  char AltCameoFile[25];
  unsigned __int8 align_70E[2];
  SHPStruct *AltCameo;
  ...
  bool CanBeHidden;
  int Points2;
  TypeList_AnimTypeClass_PTR Explosion;
  TypeList_AnimTypeClass_PTR DestroyAnim;
  ...
  TypeList_ParticleSystemTypeClass_PTR DamageParticleSystems;
  TypeList_ParticleSystemTypeClass_PTR DestroyParticleSystems;
  ...
  unsigned __int8 align_CC9;
  unsigned __int8 align_CCA;
  unsigned __int8 align_CCB;
  bool Repairable;
  bool Crewed;
  bool Naval;
  bool Remapable;
  ...
  unsigned int RequiredHouses;
  unsigned int ForbiddenHouses;
  unsigned int SecretHouses;
  bool UseBuffer;
  ...
  int ZFudgeBridge;
  char PaletteFile[32];
  DynamicVectorClass_ColorScheme_PTR *Palette;
...
struct LinkClass_vtbl
{
  ...
  LinkClass *(__thiscall *HeadOfList)(LinkClass *this, LinkClass *);
  LinkClass *(__thiscall *TailOfList)(LinkClass *this, LinkClass *);
...
struct GadgetClass_vtbl
{
  ...
  LinkClass *(__thiscall *HeadOfList)(GadgetClass *this, LinkClass *);
  LinkClass *(__thiscall *TailOfList)(GadgetClass *this, LinkClass *);
...
class MapClass : GScreenClass
{
  ...
  int TotalValue;
  VectorClass_CellClass_PTR Cells;
  int MaxLevel;
  int MaxWidth;
  int MaxHeight;
  int MaxNumCells;
  Crate Crates[256];
  int Redraws;
  DynamicVectorClass_CellStruct TaggedCells;
};
...
class SidebarClass : PowerClass
{
  ...
  int DiplomacyKills[8];
  int DiplomacyOwned[8];
  int DiplomacyPowerDrain[8];
  ColorScheme *DiplomacyColors[8];
  unsigned int unknown_544C[8];
  unsigned int unknown_546C[8];
  unsigned int unknown_548C[8];
  unsigned int unknown_54AC[8];
  unsigned int unknown_54CC[8];
  unsigned int unknown_54EC[8];
  unsigned __int8 unknown_550C;
  int DiplomacyNumHouses;
  bool unknown_bool_5514;
  bool unknown_bool_5515;
  unsigned __int8 padding_5516[2];
};
...
class __declspec(align(8)) BuildingClass : TechnoClass
{
  ...
  int BState;
  int QueueBState;
  unsigned int OwnerCountryIndex;
  ...
  BuildingTypeClass *Upgrades[3];
  int FiringSWType;
  unsigned int unknown_5FC;
  ...
  unsigned int SupportingPrisms;
  bool HasExtraPowerBonus;
  bool HasExtraPowerDrain;
  DynamicVectorClass_InfantryClass_PTR Overpowerers;
  DynamicVectorClass_InfantryClass_PTR Occupants;
  ...
  unsigned __int8 CloakRadius;
  char Translucency;
  unsigned int StorageFilledSlots;
  ...
  unsigned int DelayBeforeFiring;
  int BunkerState;
};
...
class BuildingTypeClass : TechnoTypeClass
{
  ...
  unsigned int align_E24;
  long double GateCloseDelay;
  int LightVisibility;
  int LightIntensity;
  int LightRedTint;
  int LightGreenTint;
  ...
  BuildingAnimStruct BuildingAnim[21];
  int Upgrades;
  ...
  char TheaterSpecificID[19];
  int NumberOfDocks;
  VectorClass_CoordStruct DockingOffsets;
...
class InfantryClass : FootClass
{
  ...
  unsigned int PanicDurationLeft;
...
class InfantryTypeClass : TechnoTypeClass
{
  ...
  int SecondaryProne;
  TypeList_AnimTypeClass_PTR DeadBodies;
  TypeList_AnimTypeClass_PTR DeathAnims;
  TypeList_int VoiceComment;
  int EnterWaterSound;
  int LeaveWaterSound;
  bool Cyborg;
  bool NotHuman;
...
class DSurface : XSurface
{
  ...
  bool IsInVideoRam;
  char field_1A[2];
  struct IDirectDrawSurface *VideoSurfacePtr;
...
struct WWMouseClass_vtbl
{
  ...
  void (__thiscall *Draw)(WWMouseClass *this, CellStruct *, SHPStruct *, int);
  ...
  unsigned __int8 (__thiscall *GetField10)(WWMouseClass *this);
  void (__thiscall *func_20)(WWMouseClass *this, RectangleStruct);
  void (__thiscall *CallFunc10)(WWMouseClass *this);
  unsigned int (__thiscall *GetRefCount)(WWMouseClass *this);
...
struct TextLabelClass_vtbl
{
  ...
  LinkClass *(__thiscall *HeadOfList)(TextLabelClass *this, LinkClass *);
  LinkClass *(__thiscall *TailOfList)(TextLabelClass *this, LinkClass *);
...
struct FileEntryClass
{
  FixedString_128_A_wchar_t Name;
  FixedString_32_A_char Filename;
  int TechLevel;
  int HouseIndex;
  FixedString_64_A_wchar_t HouseName;
  int CampaignIndex;
  Tag_FILETIME LastWriteTime;
  bool IsValid;
  bool IsWrongVersion;
  unsigned __int8 align_1B6[2];
  GameMode GameMode;
};
...
struct LoadOptionsClass_vtbl
{
  ...
  wchar_t *(__thiscall *GetUIString_GameSaved)(LoadOptionsClass *this);
};
...
struct AircraftTrackerClass
{
  ...
  DynamicVectorClass_TechnoClass_PTR CurrentVector;
};

struct __declspec(align(4)) ToolTip
{
...
struct ThemeClass
{
  ...
  bool IsFading;
  bool IsScoreShuffle;
  DynamicVectorClass_ThemeClass_PTR Themes;
  AudioStream *Stream;
};
...
class IsometricTileTypeClass : ObjectTypeClass
{
  ...
  unsigned int unk_2A0;
  DynamicVectorClass_Color16Struct_PTR unk_2A4;
  unsigned int unk_2BC;
  int ToSnowTheater;
  ...
  int TileAttachesTo;
  int TileZAdjust;
  unsigned int unk_2DC;
  bool Morphable;
  bool ShadowCaster;
  bool AllowToPlace;
  bool RequiredByRMG;
  unsigned int unk_2E4;
  unsigned int unk_2E8;
  unsigned int unk_2EC;
  int unk_2F0;
  bool unk_2F4;
  char FileName[14];
  bool AllowBurrowing;
...
struct ControlClass_vtbl
{
  ...
  LinkClass *(__thiscall *HeadOfList)(ControlClass *this, LinkClass *);
  LinkClass *(__thiscall *TailOfList)(ControlClass *this, LinkClass *);
...
struct ToggleClass_vtbl
{
  ...
  LinkClass *(__thiscall *HeadOfList)(ToggleClass *this, LinkClass *);
  LinkClass *(__thiscall *TailOfList)(ToggleClass *this, LinkClass *);
...
struct ShapeButtonClass_vtbl
{
  ...
  LinkClass *(__thiscall *HeadOfList)(ShapeButtonClass *this, LinkClass *);
  LinkClass *(__thiscall *TailOfList)(ShapeButtonClass *this, LinkClass *);
...
struct EditClass_vtbl
{
  ...
  LinkClass *(__thiscall *HeadOfList)(EditClass *this, LinkClass *);
  LinkClass *(__thiscall *TailOfList)(EditClass *this, LinkClass *);
...
struct GaugeClass_vtbl
{
  ...
  LinkClass *(__thiscall *HeadOfList)(GaugeClass *this, LinkClass *);
  LinkClass *(__thiscall *TailOfList)(GaugeClass *this, LinkClass *);
...
struct SliderClass_vtbl
{
  ...
  LinkClass *(__thiscall *HeadOfList)(SliderClass *this, LinkClass *);
  LinkClass *(__thiscall *TailOfList)(SliderClass *this, LinkClass *);
...
class ListClass : ControlClass
{
  TextPrintType TextFlags;
  void *Tabs;
  DynamicVectorClass_char_PTR List;
  int LineHeight;
  int LineCount;
  bool IsScrollActive;
...
struct ListClass_vtbl
{
  ...
  LinkClass *(__thiscall *HeadOfList)(ListClass *this, LinkClass *);
  LinkClass *(__thiscall *TailOfList)(ListClass *this, LinkClass *);
...
struct DropListClass_vtbl
{
  ...
  LinkClass *(__thiscall *HeadOfList)(DropListClass *this, LinkClass *);
  LinkClass *(__thiscall *TailOfList)(DropListClass *this, LinkClass *);
...
struct TriColorGaugeClass_vtbl
{
  ...
  LinkClass *(__thiscall *HeadOfList)(TriColorGaugeClass *this, LinkClass *);
  LinkClass *(__thiscall *TailOfList)(TriColorGaugeClass *this, LinkClass *);
...
struct CheckListClass_vtbl
{
  ...
  LinkClass *(__thiscall *HeadOfList)(CheckListClass *this, LinkClass *);
  LinkClass *(__thiscall *TailOfList)(CheckListClass *this, LinkClass *);
...
struct ColorListClass_vtbl
{
  ...
  LinkClass *(__thiscall *HeadOfList)(ColorListClass *this, LinkClass *);
  LinkClass *(__thiscall *TailOfList)(ColorListClass *this, LinkClass *);
...
{
  CDTimerClass UpdateTimer;
  DynamicVectorClass_KamikazeControl_PTR Nodes;
};
