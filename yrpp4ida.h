...
{
  TextPrintType_LASTPOINT = 0x0,
  TextPrintType_LASTSHADOW = 0x0,
  TextPrintType_Point6 = 0x1,
  TextPrintType_Point8 = 0x2,
  TextPrintType_Point3 = 0x3,
  TextPrintType_Led = 0x4,
  TextPrintType_Vcr = 0x5,
  TextPrintType_Point6Grad = 0x6,
  TextPrintType_Map = 0x7,
  TextPrintType_Metal12 = 0x8,
  TextPrintType_Efnt = 0x9,
  TextPrintType_Type = 0xA,
  TextPrintType_Score = 0xB,
  TextPrintType_Fonts = 0xF,
  TextPrintType_NoShadow = 0x10,
  TextPrintType_DropShadow = 0x20,
  TextPrintType_FullShadow = 0x40,
  TextPrintType_LightShadow = 0x80,
  TextPrintType_Center = 0x100,
  TextPrintType_Right = 0x200,
  TextPrintType_Background = 0x400,
  TextPrintType_MediumColor = 0x1000,
  TextPrintType_BrightColor = 0x2000,
  TextPrintType_UseGradPal = 0x4000,
  TextPrintType_UnknownColor = 0x8000,
  TextPrintType_GradAll = 0xF000,
};
...
enum __bitmask EditFlag : int
{
	...
	EditFlag_Digit = 0x2,
	EditFlag_Other = 0x4,
	EditFlag_ToUpper = 0x8
};

enum __bitmask SpotlightFlags : unsigned int
{
  SpotlightFlags_NoColor = 0x1,
  SpotlightFlags_NoRed = 0x2,
  SpotlightFlags_NoGreen = 0x4,
  SpotlightFlags_NoBlue = 0x8
};

enum __bitmask ScenarioFlags : unsigned int
{
  ScenarioFlags_bit00 = 0x1,
  ScenarioFlags_bit01 = 0x2,
  ScenarioFlags_bit02 = 0x4,
  ScenarioFlags_bit03 = 0x8,
  ScenarioFlags_CTFMode = 0x10,
  ScenarioFlags_Inert = 0x20,
  ScenarioFlags_TiberiumGrows = 0x40,
  ScenarioFlags_TiberiumSpreads = 0x80,
  ScenarioFlags_MCVDeploy = 0x100,
  ScenarioFlags_InitialVeteran = 0x200,
  ScenarioFlags_FixedAlliance = 0x400,
  ScenarioFlags_HarvesterImmune = 0x800,
  ScenarioFlags_FogOfWar = 0x1000,
  ScenarioFlags_bit13 = 0x2000,
  ScenarioFlags_TiberiumExplosive = 0x4000,
  ScenarioFlags_DestroyableBridges = 0x8000,
  ScenarioFlags_Meteorites = 0x10000,
  ScenarioFlags_IonStorms = 0x20000,
  ScenarioFlags_Visceroids = 0x40000,
  ScenarioFlags_bit19 = 0x80000,
  ScenarioFlags_bit20 = 0x100000,
  ScenarioFlags_bit21 = 0x200000,
  ScenarioFlags_bit22 = 0x400000,
  ScenarioFlags_bit23 = 0x800000,
  ScenarioFlags_bit24 = 0x1000000,
  ScenarioFlags_bit25 = 0x2000000,
  ScenarioFlags_bit26 = 0x4000000,
  ScenarioFlags_bit27 = 0x8000000,
  ScenarioFlags_bit28 = 0x10000000,
  ScenarioFlags_bit29 = 0x20000000,
  ScenarioFlags_bit30 = 0x40000000,
